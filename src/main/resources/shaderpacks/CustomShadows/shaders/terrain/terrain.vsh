...
// CustomShadows Pack - Vertex Shader
// Passes world position and split lighting data to fragment for shadow calculations.
...
layout (location = 5) out vec4 rawColor;
layout (location = 6) out vec4 lightmapColor;
...
void main() {
    ...
    vec4 lmColor = sample_lightmap2(Sampler2, Position.a);
    
    vertexColor = Color * lmColor;
    rawColor = Color;
    lightmapColor = lmColor;
    worldPos = pos;
